...
namespace KostenVoranSchlagConsoleParser.Api
{
	...
	class ConnectHelper
	{
		...
		private static Configuration GreateConfiguration()
		{
			...
			var serverUrl = "https://education.crm2016.uds.systems/";//connStringParts["Server"];
			var login = @"uds\y.fusyuk"; // connStringParts["Username"];
			var pass =  "YF6844"; //connStringParts["Password"];
